...
describe("GeoService", () => {
  ...
  describe("findGeoMetaFromIp", () => {
    it("should return the geo meta from ip", async () => {
      mockFetch.mockResolvedValue({ ok: true, json: () => Promise.resolve({ country_name: "United States", city: "New York", region: "NY", latitude: 40.7128, longitude: -74.006, languages: "en-US", country_calling_code: "+1" }) } as unknown as Response);
